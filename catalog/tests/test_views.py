...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        # Create 13 authors to test pagination.
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Check that we now have borrowed books in list
        response = self.client.get(reverse('my-borrowed'))
        # Check user is logged in
        self.assertEqual(str(response.context['user']), 'testuser1')
        # Check that we got a response "success"
...
class RenewBookInstancesView(TestCase):
    def setUp(self):
        # Create two users
        test_user1 = User.objects.create_user(username='testuser1', password='password1')
        test_user2 = User.objects.create_user(username='testuser2', password='password2')
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        ...
        # Check that it let us login - this is our book and we have the right permissions
        self.assertEqual(response.status_code, 200)
    ...
    def test_logged_in_with_permission_another_users_borrowed_book(self):
        ...
        # Check that it let us login. We are a librarian, so we can view any users book
        self.assertEqual(response.status_code, 200)
    ...
    def test_redirects_to_all_borrowed_book_in_list_on_success(self):
        login = self.client.login(username='testuser2', password='password2')
